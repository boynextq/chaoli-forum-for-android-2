package com.daquexian.chaoli.forum.meta.parse;
...
public class TextWithFormula extends SpannableStringBuilder {
    ...
    public void addFormula(int start, int end, String content, int contentStart,
        ...
        Matcher matcher = newlinePattern.matcher(this);

        while (matcher.find()) {
            this.replace(matcher.start(), matcher.end(), "");
            matcher = newlinePattern.matcher(this);
        }
    }
